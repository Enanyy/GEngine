...
namespace network {
	...
	protected:
		...
		virtual void on_tcpreceive(uv_session* session, const char* data, const size_t length) = 0;
		virtual void on_udpreceive(sockaddr_in* addr, const char* data, const size_t length) = 0;
